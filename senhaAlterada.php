...
<div class='container col-sm-10 col-md-8'>
    <div class='cabecalho'>
        ...
        <div class='textoCabecalho'>
            ...
            Por questões de segurança, defina uma nova senha abaixo, antes de realizar o acesso.
        </div>
    </div>
    <div class='corpo_form'>
        <form accept-charset="UTF-8" role="form" onSubmit="javascript:definirNovaSenha(event)">
            <div class='row'>
                <input type='hidden' name='emailAlterarSenha' style='margin-top: 10px' class='form-control' value='<?=$_SESSION['email']?>'/>
                <div class='col-sm-12 col-md-4'>
                    <input type='password' name='senhaProvisoria' style='margin-top: 10px' class='form-control' placeholder='Senha provisória'/>
                </div>
                <div class='col-sm-12 col-md-4'>
